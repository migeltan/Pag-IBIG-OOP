...
public class MemberTable {
    ...
    private String membershipTypeOthers;
    private String membershipCategory;
    private String membershipCategoryOthers;
    ...
    public MemberTable(String pagIbigMIDNo, String occupationalStatus, String membershipType,
                       String membershipTypeOthers, String membershipCategory,
                       String membershipCategoryOthers, String memberName,
        ...
        this.membershipTypeOthers = membershipTypeOthers;
        this.membershipCategory = membershipCategory;
        this.membershipCategoryOthers = membershipCategoryOthers;
    ...
    public String getMembershipTypeOthers()                  { return membershipTypeOthers; }
    public void setMembershipTypeOthers(String v)            { this.membershipTypeOthers = v; }
    ...
    public String getMembershipCategoryOthers()              { return membershipCategoryOthers; }
    public void setMembershipCategoryOthers(String v)        { this.membershipCategoryOthers = v; }
