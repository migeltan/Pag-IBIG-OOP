...
public class SecurityQuestionsSetupFrame extends JFrame {
   ...
   // ── WIDGETS REFERENCED ACROSS METHODS ───────────────────────────────────
   ...
   // ────────────────────────────────────────────────────────────────────────
   public SecurityQuestionsSetupFrame() {
   ...
   private JPanel buildStep1() {
       ...
       card.add(vgap(8));
       card.add(desc);
       card.add(vgap(28)); // <-- removed divider() call here
   ...
   private void addQBlock(JPanel parent, String label,
       ...
       badge.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       // Combo — centered
       combo.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       ...
       ansLbl.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       // Answer row with show/hide — centered
       JPanel ansRow = new JPanel(new BorderLayout(0, 0));
       ansRow.setOpaque(false);
       ansRow.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
   ...
   private JPanel buildStep3() {
       JPanel page = pageWrapper();
       JPanel card = createCard();
       // Custom-painted checkmark — avoids emoji rendering issues in Swing
   ...
   private JLabel reviewLbl(String text, boolean bold) {
       ...
       l.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       return l;
   }
   private JPanel reviewRow(String tag, JLabel q, JLabel a) {
       ...
       p.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       ...
       tagLbl.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       JPanel sep = new JPanel();
       sep.setBackground(new Color(0, 200, 140, 50));
       sep.setMaximumSize(new Dimension(Integer.MAX_VALUE, 1));
       sep.setAlignmentX(Component.CENTER_ALIGNMENT); // centered
       p.add(tagLbl);
       p.add(vgap(6));
       p.add(sep);
       p.add(vgap(10));
   ...
   public static void main(String[] args) {
       SwingUtilities.invokeLater(() -> new SecurityQuestionsSetupFrame().setVisible(true));
   }
}
